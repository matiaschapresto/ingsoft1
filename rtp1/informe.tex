...
\pagestyle{fancy}
\thispagestyle{fancy}
\lhead{Recuperatorio TP1 · Ingeniería de Software I}
\rhead{Vileriño · Chapresto · Garassino · Sarri\'es · Barbeito}
\renewcommand{\footrulewidth}{0.4pt}
\cfoot{\thepage / 15 } %\pageref{LastPage}
...
% Quita enumeración de las secciones del índice para q no se confundan con las numeraciones a mano que hay en los diagramas
\setcounter{secnumdepth}{0}

% Para la referencia dentro de itemize
...
%\includegraphics[height=2cm]{img/logo_dc.jpg} 
\hfill
