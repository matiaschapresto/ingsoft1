...
\end{usecase}
\begin{usecasesteps}
  \ucstep{El taxista marca un viaje como \texttt{Finalizado.} y reporta el pago \texttt{CU Reportando el pago de un viaje}}{}
  \ucstep{El sistema asigna el estado de este viaje a finalizado.}{}
  \ucstep{Fin caso de uso.}{}
  \ucstep{Incluye al \texttt{CU Reportando el pago de un viaje}.}{}
\end{usecasesteps}
...
\end{usecase}
\begin{usecasesteps}
  \ucstep{El directivo accede al menu de estadisticas y selecciona \texttt{Calificaciones de taxistas}.}{}
...
\end{usecase}
\begin{usecasesteps}
  \ucstep{El directivo accede al menu de estadisticas y selecciona \texttt{Facturacion}.}{}
...
\end{usecase}
\begin{usecasesteps}
  \ucstep{El directivo accede al menu de estadisticas y selecciona \texttt{Viajes realizados}.}{}
  \ucstep{El sistema muestra en pantalla la informacion de Viajes realizados.}{}
  \ucstep{Fin caso de uso.}{}
\end{usecasesteps}


\textbf{EL DIRECTIVO SE REGISTRA Y SE LOGUEA? OPERADORA PERSONIFICA DIRECTIVO?Tienen una web intranet aparte los directivos? O es publico en la web el sitio de estadisticas?}