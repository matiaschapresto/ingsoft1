...
\item Modelado prescinde en general de FSMs y del modelado del tiempo con temporizadores.
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Modelar la asignación de viajes con FSM por las caracteristicas concurrentes de los actores: pasajeros y taxistas.
\item Personificacion total de la operadora sobre el pasajero y el taxista por medios de comunicacion redundantes para fortalecer la solidez del sistema.
\item Modelar sistema estadistico en sistema externo para delegar tareas.
\end{itemize}
\end{frame}
